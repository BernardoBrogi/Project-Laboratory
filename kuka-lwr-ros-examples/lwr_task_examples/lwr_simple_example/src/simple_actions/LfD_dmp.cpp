...
namespace simple_actions {
    ...
    LfD_dmp_action::LfD_dmp_action(ros::NodeHandle& nh):
    Ros_ee_j(nh),
...
bool LfD_dmp_action::update(){
    ...
    int index;
    std::ifstream infile;
    infile.open("/home/hwadong/catkin_ws/src/lwr_gbz/plan.txt");
...
void LfD_dmp_action::simple_line_policy(Eigen::Vector3d& linear_velocity,
                                            Eigen::Vector3d& angular_velocity,
