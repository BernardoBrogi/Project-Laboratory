#ifndef KUKA_LWR_LFD_DMP_H
#define KUKA_LWR_LFD_DMP_H
...
class LfD_dmp_action : public ros_controller_interface::Ros_ee_j, public ac::Base_action {

public:


    LfD_dmp_action(ros::NodeHandle& nh);
