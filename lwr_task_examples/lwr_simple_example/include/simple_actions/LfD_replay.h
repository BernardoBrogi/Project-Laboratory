#ifndef KUKA_LWR_LFD_REPLAY_H
#define KUKA_LWR_LFD_REPLAY_H
...
class LfD_replay_action : public ros_controller_interface::Ros_ee_j, public ac::Base_action {

public:


    LfD_replay_action(ros::NodeHandle& nh);
